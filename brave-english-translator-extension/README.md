...
- For harder sites, the extension now tries OCR by image URL first and then retries by uploading the in-browser image bytes (helps with pages like nhentai image hosts).
